...
THUMBNAIL_URL = "METS_TON_LIEN_DISCORD_ICI" # Colle ici le lien de l'image envoyée sur Discord
# ------------------------------
...
@bot.tree.command(name="tos", description="Display Terms of Service")
...
@bot.tree.command(name="setup_tos", description="Post permanent TOS")
...
@bot.tree.command(name="setup_panel", description="Generate the Support Center")
@app_commands.default_permissions(administrator=True)
...
class TicketSelect(discord.ui.Select):
    def __init__(self):
        options = [
            ...
            discord.SelectOption(label="Business", description="Promote", emoji="💼"),
            discord.SelectOption(label="Questions", description="Support", emoji="❔")
        ]
