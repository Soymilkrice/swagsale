...
# --- ID CONFIGURATION ---
# Railway will pull the token from your "Variables" tab
...
if TOKEN:
    ...
    print("✧ CRITICAL ERROR: DISCORD_TOKEN not found in environment variables.")class TicketControlView(discord.ui.View):
    def __init__(self):
        super().__init__(timeout=None)
        self.staff_notified = False 
